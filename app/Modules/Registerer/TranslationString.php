...
class TranslationString
{
    ...
    public static function getSettingsI18n()
    {
        $i18n = array(
            ...
            'Error Message Handle' => __('Error Message Handle', 'fluentform'),
            'Select the default error message handle. Error messages can be handle after form submit, or immediate after change field value.' => __('Select the default error message handle. Error messages can be handle after form submit, or immediate after change field value.', 'fluentform'),
            'When form validation error messages will be shown' => __('When form validation error messages will be shown', 'fluentform'),
            ...
            'Receive an instant email notification when any of your integration is not running. Enable Integration Failure Notification and you will get an email when any of your integration fails to run.' => __('Receive an instant email notification when any of your integration is not running.Enable Integration Failure Notification and you will get an email when any of your integration fails to run.', 'fluentform'),
