...
<div class="ffc_conv_wrapper">
    <div class="ff_conv_app ff_conv_app_frame fluent_form_<?php echo $form_id; ?> ff_conv_app_<?php echo $form_id; ?> ffc_media_hide_mob_<?php echo $design['hide_media_on_mobile']; ?>" data-form_id="<?php echo $form_id ?>">
